...
export default function SpecificMusic(){
    ...
    //console.log(alreadyLiked, alreadyCollected)
                    ...
                    <div className="specific-features">
                        ...
                        
                        {
                            alreadyCollected.includes(parseInt(choose))?
                                <button onClick={clickDiscollect}><HeartOutlined className="feature" style={redStyle}/><span style={redStyle} className="feature-letter">Collect</span></button>
                            :
